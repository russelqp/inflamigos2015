...
<?php
   $ruta=$dir_brincolines."inflables/thumbs/".$brincolin."/";
   $ruta2=$dir_brincolines."inflables/g/".$brincolin."/brincolin_inflable_";
   $images = glob($ruta . "*");
   echo "<h4>Imagenes:</h4><ul>" ; 
	 ...
	 { 
	    ...
	    echo '<li><a href="'.$ruta2.$name[0].$name[1].$ext.'" data-target="flare" data-flare-gallery="gallery1" data-flare-thumb="'.$image.'" title="'.$titulo.'"><img src="'.$image.'" alt="'.$brincolin."_thumb".'" /></a></li>';
